...
const defaultState = {
  puzzlesCompleted: [false, false, false, false, false, false, false, false, false],
  currentPuzzle: 0,
...
export function useGameStore() {
  ...
  const resetProgress = () => {
    state.puzzlesCompleted = [false, false, false, false, false, false, false, false, false]
  ...
  const unlockAll = () => {
    state.puzzlesCompleted = [true, true, true, true, true, true, true, true, true]
    state.wrappedUnlocked = true
  }
